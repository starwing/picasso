...
public: 
    ...
    virtual void init(void* ptr, unsigned int width, unsigned int height, int stride) = 0;

    virtual unsigned int width(void) const = 0;
    virtual unsigned int height(void) const = 0;
    virtual int stride(void) const = 0;
    virtual void* buffer(void) const = 0;
...
public:
    ...
    virtual void attach(void* buf, unsigned int width, unsigned int height, int stride) = 0;
...
public:
    ...
    virtual void write_glyph_to(void* buffer) = 0;
...
public:
    ...
    virtual void* create_storage(void* buf, unsigned int len, scalar x, scalar y) = 0;
