...
public:
    ...
    void transform(const abstract_trans_affine* trans, unsigned int id = 0);
    void transform_all_paths(const abstract_trans_affine* trans);
    ...
    // serialize
    void serialize_to(void* buffer);
    void serialize_from(unsigned int num, void* buffer, unsigned int buf_len);
private:
